...
def add_cafe():
    ...
    if form.validate_on_submit():
        data.clear()
        data.append(form.cafe.data)
        data.append(form.location.data)
        data.append(form.open_time.data)
        data.append(form.close_time.data)
        data.append(form.coffee.data)
        data.append(form.wifi.data)
        data.append(form.power.data)
        with open("cafe-data.csv", "a", newline='', encoding="utf-8") as csv_file:  # noqa E501
